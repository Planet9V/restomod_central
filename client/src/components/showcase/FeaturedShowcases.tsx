  ...
  if (error || !showcases || showcases.length === 0) {
    return (
      <div className="text-center py-12">
        <h3 className="text-xl font-medium mb-2">No featured showcases available</h3>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {showcases.map((showcase) => (
        <Card 
          key={showcase.id} 
          className="flex flex-col h-full overflow-hidden group transition-all duration-300 hover:shadow-lg"
        >
          <div 

...
export const marketData = sqliteTable("market_data", {
  id: integer("id").primaryKey({ autoIncrement: true }),
  marketGrowthData: text("market_growth_data").notNull(),
  demographicData: text("demographic_data").notNull(),
  platforms: text("platforms").notNull(),
  modifications: text("modifications").notNull(),
...
export const luxuryShowcases = sqliteTable("luxury_showcases", {
  ...
  galleryImages: text("gallery_images").notNull(),
  detailSections: text("detail_sections").notNull(),
...
export const researchArticles = sqliteTable("research_articles", {
  ...
  publishDate: integer("publish_date", { mode: "timestamp" }).defaultNow().notNull(),
...
export const engineOptions = sqliteTable("engine_options", {
  ...
  mcKenneyFeatures: text("mckenney_features"),
  createdAt: integer("created_at", { mode: "timestamp" }).defaultNow().notNull(),
});
...
export const transmissionOptions = sqliteTable("transmission_options", {
  ...
  image: text("image").notNull(),
  price: text("price").notNull(),
  compatibleEngines: text("compatible_engines").notNull(),
  compatibleModels: text("compatible_models").notNull(),
  createdAt: integer("created_at", { mode: "timestamp" }).defaultNow().notNull(),
});
...
export const colorOptions = sqliteTable("color_options", {
  ...
  availableForModels: text("available_for_models").notNull(),
...
export const userConfigurations = sqliteTable("user_configurations", {
  ...
  selectedAiOptions: text("selected_ai_options"),
  selectedAdditionalOptions: text("selected_additional_options"),
...
export const eventVenues = sqliteTable("event_venues", {
  ...
  judgingClasses: text("judging_classes"),
...
export const investmentAnalytics = sqliteTable("investment_analytics", {
  ...
  lastAnalyzed: integer("last_analyzed", { mode: "timestamp" }).defaultNow(),
  createdAt: integer("created_at", { mode: "timestamp" }).defaultNow(),
});
...
export const enhancedVehiclePlatforms = sqliteTable('enhanced_vehicle_platforms', {
  ...
  imageUrl: text('image_url'),
  bodyTypes: text('body_types').notNull(),
...
export const enhancedEngineOptions = sqliteTable('enhanced_engine_options', {
  ...
  compatiblePlatforms: text('compatible_platforms').notNull(),
...
export const configuratorRearAxleOptions = sqliteTable('configurator_rear_axle_options', {
  ...
  manufacturer: text('manufacturer').notNull(),
  torqueRating: integer('torque_rating').notNull(),
  gearRatios: text('gear_ratios').notNull(),
...
export const configuratorCustomerConfigurations = sqliteTable('configurator_customer_configurations', {
  ...
  additionalOptions: text('additional_options').notNull(),
...
export const carsForSale = sqliteTable("cars_for_sale", {
  ...
  imageUrl: text("image_url"),
  description: text("description"),
  features: text("features"), // Flexible JSON for various features
  ...
  marketData: text("market_data"), // Pricing trends, comparable sales, etc
  perplexityAnalysis: text("perplexity_analysis"), // AI-generated market insights

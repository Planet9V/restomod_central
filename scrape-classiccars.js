...
async function scrapeClassicCars() {
    ...
    const cars = await page.evaluate(() => {
      ...
      listingElements.forEach((listing) => {
        try {
          ...
          const yearMatch = yearText.match(/\b(19[6-9]\d)\b/);
...
scrapeClassicCars()
  .then(cars => {
    const outputPath = '/home/user/restomod_central/data/scraped-cc-muscle-60s.json';
